...
- **v2 (staging, live):** `https://dextro9494.github.io/sovereign-library-v2/`

---

## 3) Repos and local paths
- Local v2 folder:  
  `C:\Users\Gebruiker\Desktop\Codex\GitHub\sovereign-library-v2`
- GitHub repo:  
  `https://github.com/dextro9494/sovereign-library-v2`
...
- `config.toml` updated:
  - `baseURL = "https://dextro9494.github.io/sovereign-library-v2/"`
...
- Added Tags to navbar in `config.toml`:
  ...
  ```
- Tags page:
  - `https://dextro9494.github.io/sovereign-library-v2/tags/`
